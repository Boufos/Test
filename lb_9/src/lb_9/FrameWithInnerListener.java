...
public class FrameWithInnerListener extends JFrame
{
    private JLabel prev;
    ...
    public FrameWithInnerListener()
    {
        ...
        prev = new JLabel ( "Enter the number of operations by N: " );
        jfrm.add ( prev );
        ...
        prev = new JLabel ( "Enter the number of operations by K: " );
        jfrm.add ( prev );
        ...
        prev = new JLabel ( "Enter the coefficient for calculation  : " );
        jfrm.add ( prev );
